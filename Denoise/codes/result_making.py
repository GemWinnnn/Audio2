...
model = keras.models.load_model('/Users/gemwincanete/Audio/model/final_best_model_denoise_.h5', compile=False)
...
est_test = mergeX(testX, seg=3)
est_test = np.reshape(est_test, (est_test.shape[0], -1))
df1 = pd.DataFrame(est_testL)
